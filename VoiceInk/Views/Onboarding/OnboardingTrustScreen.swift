...
struct OnboardingTrustScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            subtitle: "Review how Muninn handles your data before choosing a license.",
...
private struct TrustHeader: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Muninn is private by default")
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 10) {
                ...
                Text("Muninn is also open source, so you can inspect every single line of code.")
                    .font(.system(size: 13))
