...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with Muninn.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle: "Select the text on the screen, tell Muninn the changes you want, and Muninn will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and Muninn will serve you the answers.",
